...
module.exports = {
  env: {
    ...
    coreSsoTicketUrl: getOptional('APPS2_CORE_SSO_TICKET_URL') || 'https://api.healthcare.cantero.ar/auth/sso-ticket',
    coreSsoExchangeUrl: getOptional('APPS2_CORE_SSO_EXCHANGE_URL') || 'https://api.healthcare.cantero.ar/auth/sso-exchange',
    coreJwksUrl: getOptional('APPS2_CORE_JWKS_URL') || 'https://api.healthcare.cantero.ar/.well-known/jwks.json',
    ...
    coreSsoFrontendBaseUrl: getOptional('APPS2_CORE_SSO_FRONTEND_BASE_URL') || 'https://turnos.solefrancisco.com',
    coreSsoRedirectFallback: getOptional('APPS2_CORE_SSO_REDIRECT_FALLBACK') || 'https://turnos.solefrancisco.com/',
    coreSsoLoginRedirect: getOptional('APPS2_CORE_SSO_LOGIN_REDIRECT') || 'https://turnos.solefrancisco.com/login',
